...
import com.aymane.ecom.multivendor.repository.CouponRepository;
...
public class CouponServiceImpl implements CouponService {
    ...
    public Cart applyCoupon(String code, double orderValue, User user) throws Exception {
        ...
        final Cart cart = this.cartRepository.findByUserId(user.getId());
        ...
        if (orderValue < coupon.getMinimumOrderValue()) {
            throw new Exception("Minimum order value required is " + coupon.getMinimumOrderValue());
        }
        ...
        if (coupon.isActive() &&
            ...
            final double discountedPrice = cart.getTotalSellingPrice() * coupon.getDiscountPercentage() / 100;
    ...
    public Coupon findCouponById(Long id) throws Exception {
        return this.couponRepository.findById(id).orElseThrow(() -> new Exception("Coupon not found"));
    }
    ...
    public void deleteCoupon(Long id) throws Exception {
        this.couponRepository.delete(this.findCouponById(id));
    }
}
